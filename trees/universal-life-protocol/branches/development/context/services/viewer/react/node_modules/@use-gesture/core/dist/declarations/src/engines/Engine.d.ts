import { Controller } from "@use-gesture/core/dist/declarations/src/Controller.js";
import { GestureKey, IngKey, State, Vector2 } from "@use-gesture/core/dist/declarations/src/types.js";
import { NonUndefined } from "@use-gesture/core/dist/declarations/src/types.js";
...
export declare abstract class Engine<Key extends GestureKey> {
     ...
     */
    get shared(): import("@use-gesture/core/dist/declarations/src/types.js").SharedGestureState;
    /**
     * Shortcut to the gesture event store read from the Controller.
     */
    get eventStore(): NonNullable<{
        drag?: import("@use-gesture/core/dist/declarations/src/EventStore.js").EventStore | undefined;
        wheel?: import("@use-gesture/core/dist/declarations/src/EventStore.js").EventStore | undefined;
        scroll?: import("@use-gesture/core/dist/declarations/src/EventStore.js").EventStore | undefined;
        move?: import("@use-gesture/core/dist/declarations/src/EventStore.js").EventStore | undefined;
        hover?: import("@use-gesture/core/dist/declarations/src/EventStore.js").EventStore | undefined;
        pinch?: import("@use-gesture/core/dist/declarations/src/EventStore.js").EventStore | undefined;
    }[Key]>;
    /**
     * Shortcut to the gesture timeout store read from the Controller.
     */
    get timeoutStore(): NonNullable<{
        drag?: import("@use-gesture/core/dist/declarations/src/TimeoutStore.js").TimeoutStore | undefined;
        wheel?: import("@use-gesture/core/dist/declarations/src/TimeoutStore.js").TimeoutStore | undefined;
        scroll?: import("@use-gesture/core/dist/declarations/src/TimeoutStore.js").TimeoutStore | undefined;
        move?: import("@use-gesture/core/dist/declarations/src/TimeoutStore.js").TimeoutStore | undefined;
        hover?: import("@use-gesture/core/dist/declarations/src/TimeoutStore.js").TimeoutStore | undefined;
        pinch?: import("@use-gesture/core/dist/declarations/src/TimeoutStore.js").TimeoutStore | undefined;
    }[Key]>;
    /**
     * Shortcut to the gesture config read from the Controller.
     */
    get config(): NonNullable<import("@use-gesture/core/dist/declarations/src/types.js").InternalConfig[Key]>;
    /**
     * Shortcut to the shared config read from the Controller.
     */
    get sharedConfig(): import("@use-gesture/core/dist/declarations/src/types.js").InternalGenericOptions;
    /**
     * Shortcut to the gesture handler read from the Controller.
     */
    get handler(): NonNullable<import("@use-gesture/core/dist/declarations/src/types.js").InternalHandlers[Key]>;
    reset(): void;
    /**

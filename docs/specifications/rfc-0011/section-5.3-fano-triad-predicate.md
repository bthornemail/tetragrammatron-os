...
**Status:** Normative  
**Cross-reference:** See RFC-0011 §6.5 for CAN-ISA binding (PROJ_FANO instruction)  
**Invariant references:** INV-12 (Fano Structural Validity), INV-13 (Fano-Triad Closure) from `TETRAGRAMMATRON_OS_FORMAL_INVARIANTS.md`
